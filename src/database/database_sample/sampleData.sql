...
INSERT INTO users(first_name, last_name, email, password, idproof, gender, role, mobile, address, city, state, zipcode) VALUES ('sagar','malik', 'sagar@test.com', 1234, 2, 'male', 'admin', 1254549877, 'bangalore', 'bangalore', 'karnataka', 560014);
...
INSERT INTO booking(user_id, room_id, check_in_date, check_out_date, remark, status, payment) VALUES(1, 2, '2022-09-10', '2022-09-11', 'Need to book room for 2 people', 'Approved', 'Paid');
INSERT INTO booking(user_id, room_id, check_in_date, check_out_date, remark, status, payment) VALUES(2, 4, '2022-09-14', '2022-09-15', 'Need to book room for 3 people', 'Approved', 'Paid');
INSERT INTO booking(user_id, room_id, check_in_date, check_out_date, remark, status, payment) VALUES(3, 3, '2022-09-13', '2022-09-16', 'Need to book room for 2 people', 'Approved', 'Paid');
INSERT INTO booking(user_id, room_id, check_in_date, check_out_date, remark, status, payment) VALUES(4, 1, '2022-09-15', '2022-09-17', 'Need to book room for single person', 'Approved', 'Paid');
INSERT INTO booking(user_id, room_id, check_in_date, check_out_date, remark, status, payment) VALUES(5, 5, '2022-09-17', '2022-09-18', 'Need to book room for 4 people', 'Approved', 'Paid');
INSERT INTO booking(user_id, room_id, check_in_date, check_out_date, remark, status, payment) VALUES(6, 6, '2023-09-22', '2023-09-23', 'Need to book room for 2 people', 'Approved', 'Paid');
...
INSERT INTO contact_us(title, mobile_no, description, email) VALUES('StarGateway', '1234567890', 'A perfect place for vacation, relaxation or as a daytime getaway.Offering dining & an outdoor pool.', 'stargateway@test.com');


INSERT INTO enquiry(first_name, last_name, mobile_no, email, remark) VALUES('shubham', 'dongare', 2345543245, 'shubham@test.com', 'please confirm availibility');
